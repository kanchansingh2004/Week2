public class UniversitySystem {
    public static void main(String[] args) {
        // Create students
        Student student1 = new Student("Kavya",1);
        Student student2 = new Student("Aashi",2);

        // Create professors
        Professor professor1 = new Professor("Dr. Pyaare Mohan");
        Professor professor2 = new Professor("Prof. Vidhya thakur");
